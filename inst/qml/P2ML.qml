...
Form
{
	...
	Group
	{
		...
		FileSelector
		{
			...
			save:									false
			fieldWidth:								300 * preferencesModel.uiScale
			value: 									libPathDir.value === "" ? "" : (libPathDir.value + "/jaspDyads/data/sender_file1.xlsx;" + libPathDir.value + "/jaspDyads/data/sender_file2.xlsx")
			multiple:								true
		}
		...
		FileSelector
		{
			...
			save:									false
			fieldWidth:								300 * preferencesModel.uiScale
			value: 									libPathDir.value === "" ? "" : (libPathDir.value + "/jaspDyads/data/receiver_file1.xlsx;" + libPathDir.value + "/jaspDyads/data/receiver_file2.xlsx")
			multiple:								true
		}
